...
public class ConnectDao {
    ...
    public boolean connectionCheck() {
        ...
        //アナウンス表示地点テーブル
        String announceTable = ("CREATE TABLE IF NOT EXISTS BBTA_AnnounceInfo(UUID VARCHAR(36) NOT NULL, Next_Or_Soon INT NOT NULL, WORLD VARCHAR(200) NOT NULL,X INT NOT NULL,Y INT NOT NULL,Z INT NOT NULL, NEXT_STATION VARCHAR(200) NOT NULL, LINE_NAME VARCHAR(200) NOT NULL, BOUND_JP VARCHAR(200), BOUND_EN VARCHAR(200), TYPE_JP VARCHAR(200) NOT NULL, DOOR_SIDE VARCHAR(5), TERMINAL INT NOT NULL DEFAULT 0, VIA_LINE_NAME VARCHAR(200), REDSTONE_ID INT UNIQUE, PRIMARY KEY(WORLD,X,Y,Z))");
        //路線情報テーブル
